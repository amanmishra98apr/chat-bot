...
async summaryStep(step){
    ...
    if(step.result===true)
    {
      ...
      //query
      var sql = "INSERT INTO reservation (user, reservationid) VALUES ('"+step.values.name+"', '"+reservationId+"')";
      ...
      await step.context.sendActivity(`Reservation successfully made. Your reservation id is : ${reservationId}`)
      endDialog = true;
